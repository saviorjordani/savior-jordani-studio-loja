...
const description =
  "Licença anual de R$ 299,90 no primeiro ano, com renovação anual de R$ 99,90, atualizações contínuas e suporte por email.";
        ...
        <div className="container-page">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-5 text-muted-foreground md:text-lg">
              Um plugin, uma licença anual. R$ 299,90 no primeiro ano e R$ 99,90 nas renovações anuais.
            </p>
          </div>
