...
export const COUPON = "SAVIZ50";

export const TOOLS = [
  "Ferramentas de Texture",
  "Frequency Separation",
  "Dodge & Burn",
  "Quick Select",
  "Color Correction",
  "Details & Skin Texture",
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Não. É necessário estar conectado à internet para usar o plugin: a chave de licença é validada online sempre que o painel é aberto. Sem conexão, as ferramentas ficam bloqueadas.",
  },
  {
